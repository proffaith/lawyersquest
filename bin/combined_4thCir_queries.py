...
qs=["\"Appeal from the United States District Court for the District of Maryland\" AND (\"trade secret\" OR nondisclosure OR noncompetition)",
"\"Appeal from the United States District Court for the District of Maryland\" ((Corporation OR \"limited liability company\") + (Dissolution OR \"derivative shareholder\" OR veil OR \"business judgment rule\"))",
"\"Appeal from the United States District Court for the District of Maryland\" (contract OR agreement) and breach -plea -employment -grievance -\"United States v.\" -family -divorce -HOA -\"real property\" -landlord -tenant -guardian - \"service of process\" -\"28 U.S.C. § 1441\" -\"default judgment\" - \"order of default\" -\"per curiam\" -\"leave to amend\" -\"alternate service\" -admiralty -\"Fed. R.Civ.P. 55\" -\"strict products liability\" -\"magistrate judge\" -\"motion for more definite statement\""
]
    ...
    while keep_going:
        try:
            ...
            for result in organic_results:
                ...
                if debug_mode==True:
                    print(f"Current record being processed: {current_line}")
