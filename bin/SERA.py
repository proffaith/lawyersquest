...
#  "api_key": "399621aa2aaf0c21a875b2186d9724de7f9c5d89c830a043022a85e173877b39",
  ...
  "q": "((Corporation OR \"limited liability company\") + (Dissolution OR \"derivative shareholder\" OR veil OR \"business judgment rule\")) -family -divorce -employment+law",
  "hl": "en",
  "as_ylo": "2023",
  "as_sdt": "4,21"
    ...
    try:
        ...
        for result in organic_results:
            ...
            if record_exists:
                ...
                query="INSERT INTO tbScrapeData (parties, citation, court, assignment, URL, snippet) VALUES ('"+title.replace("'","")+"','"+citation.replace("'","")+"',1,17,'"+short_link+"','"+snip.replace("'","")+"')"
