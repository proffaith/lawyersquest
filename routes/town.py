...
@town_bp.route('/clue', methods=['GET'])
def clue():
    clue_message = flask_session.pop("clue_message", "You cannot make out any letters on the old, rusty sign")
    return render_template("clue.html", clue_message=clue_message)
